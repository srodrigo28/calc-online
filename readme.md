...
````
-- ============================================================
-- 📦 Tabela Principal: registros_financeiros
...
-- ============================================================
-- 👁️ View 2: resumo_geral
-- Total de entradas, saídas e cálculo de saldo de caixa
...
-- ============================================================
-- 👁️ View 3: registros_detalhados
-- Exibe todos os registros já com o valor_total calculado
-- Útil para evitar redundância ou validar integridade
-- ============================================================
...
-- ============================================================
-- 🔒 Dica adicional:
-- Após criar essas estruturas, ative RLS e defina policies
-- para proteger acessos de acordo com o usuário logado
-- ============================================================
-- example:
-- alter table public.registros_financeiros enable row level security;
-- create policy "Usuário pode ler" on registros_financeiros
...
('Pagamento via Cielo', 'entrada', 'cielo-cartão', 1, 500.00, 500.00),
('Saque do Caixa', 'saida', 'retiradas', 1, 100.00, 100.00),
('Depósito Inicial', 'entrada', 'caixa-inicial', 1, 1000.00, 1000.00),
('Pagamento de Contrato', 'saida', 'contratos', 1, 300.00, 300.00),
('Recebido em Dinheiro', 'entrada', 'dinheiro', 3, 50.00, 150.00),
('Venda via Débito', 'entrada', 'infiniti-débito', 1, 250.00, 250.00);
